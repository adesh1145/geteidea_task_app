...
//
//     final pickupSearchResponseModel = pickupSearchResponseModelFromJson(jsonString);

import 'dart:convert';

AddressListModel pickupSearchResponseModelFromJson(String str) =>
    AddressListModel.fromJson(json.decode(str));

String pickupSearchResponseModelToJson(AddressListModel data) =>
