...
//
//     final DropSearchResponseModel = DropSearchResponseModelFromJson(jsonString);

import 'dart:convert';

DropSearchResponseModel DropSearchResponseModelsFromJson(String str) => DropSearchResponseModel.fromJson(json.decode(str));

String DropSearchResponseModelToJson(DropSearchResponseModel data) => json.encode(data.toJson());

class DropSearchResponseModel {
    List<Prediction>? predictions;
    String? status;

    DropSearchResponseModel({
        this.predictions,
        this.status,
    });

    factory DropSearchResponseModel.fromJson(Map<String, dynamic> json) => DropSearchResponseModel(
